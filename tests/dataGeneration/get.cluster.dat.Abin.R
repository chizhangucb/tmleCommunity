...
comPop.wmT.bA.bY <- get.fullDat.Abin(J = 4000, n.ind = 4000, rndseed = NULL, is.Y.bin = T, working.model = T, n.ind.fix = T, onlyYkeep = T)
...
comSample.wmT.bA.bY <- get.fullDat.Abin(J = J, n.ind = n.ind, rndseed = rndseed, is.Y.bin = T, working.model = T, n.ind.fix = T)
...
comPop.wmF.bA.bY <- get.fullDat.Abin(J = 4000, n.ind = 4000, rndseed = NULL, is.Y.bin = T, working.model = F, n.ind.fix = T, onlyYkeep = T)
mean(comPop.wmF.bA.bY$Y1) # 
mean(comPop.wmF.bA.bY$Y0) # 
psi0.Y <- mean(comPop.wmF.bA.bY$Y1) - mean(comPop.wmF.bA.bY$Y0) # 

comSample.wmF.bA.bY <- get.fullDat.Abin(J = J, n.ind = n.ind, rndseed = rndseed, is.Y.bin = T, working.model = T, n.ind.fix = T)
