...
f.gstar <- define_f.gstar(shift = sampleDat_iidcontAContY$shift.val, 
                          truncBD = sampleDat_iidcontAContY$truncBD, 
                          rndseed = sampleDat_iidcontAContY$rndseed)

tmleCom_Options(Qestimator = "speedglm__glm", gestimator = "speedglm__glm", 
                maxNperBin = nrow(dat_iidcontAContY))
# Don't normalize continous covariates here
