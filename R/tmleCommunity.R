...
#'    argument \code{bin.method="dhist"} to \code{tmleCom_Options()} prior to calling \code{tmleCommunity()}. For consistency, We use the slope
#'     a = \eqn{5\times \textrm{IQR}(A)} as suggested by Denby and Mallows ("Variations on the Histogram" (2009)). For more details, please  
#'    also see this paper.
#' }
#'
